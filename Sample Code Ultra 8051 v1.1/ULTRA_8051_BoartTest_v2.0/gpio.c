...
void GPIO_PinWrite(gpioPins_et enm_pinNumber, uint8_t var_pinValue_u8)
{
    ...
    {
    case 0:
        util_UpdateBit(P0,enm_pinNumber,var_pinValue_u8);
        break;

    case 1:
        util_UpdateBit(P1,enm_pinNumber,var_pinValue_u8);
        break;

    case 2:
        util_UpdateBit(P2,enm_pinNumber,var_pinValue_u8);
        break;

    case 3:
        util_UpdateBit(P3,enm_pinNumber,var_pinValue_u8);
        break;
    }                
}
