 ...
 ***************************************************************************************************/
#define M_RowColDirection P2       //PORT Direction Configuration for keypad
#define M_ROW P2                 //Higher four bits of PORT are used as ROWs
#define M_COL P2                   //Lower four bits of PORT are used as COLs
